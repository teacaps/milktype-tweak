  ...
  return [
    {
      ...
      keycodes: [
        ...
        {name: 'Print', code: 'KC_PSCR', shortName: 'Print'},
        ...
        {name: 'Insert', code: 'KC_INS', keys: 'insert', shortName: 'Insert'},
        ...
        {name: 'Num\nLock', code: 'KC_NLCK', keys: 'num', shortName: 'Num\nLock'},
        {name: 'Caps', code: 'KC_CAPS', keys: 'caps_lock', width: 1750, shortName: 'Caps'},
        ...
        {name: 'R Shift', code: 'KC_RSFT', width: 2750, shortName: 'R Shift'},
        {name: 'L Ctrl', code: 'KC_LCTL', keys: 'ctrl', width: 1250, shortName: 'L Ctrl'},
        {name: 'R Ctrl', code: 'KC_RCTL', width: 1250, shortName: 'R Ctrl'},
        {
          name: 'L Win',
          code: 'KC_LGUI',
          keys: 'cmd',
        ...
        {name: 'R Win', code: 'KC_RGUI', width: 1250, shortName: 'R Win'},
        {
          name: 'L Alt',
          code: 'KC_LALT',
          keys: 'alt',
        ...
        {name: 'R Alt', code: 'KC_RALT', width: 1250, shortName: 'R Alt'},
        {name: 'Space', code: 'KC_SPC', keys: 'space', width: 6250},
        {name: 'Menu', code: 'KC_APP', width: 1250, shortName: 'R Menu'},
    ...
    },
    {
      ...
      keycodes: [
        ...
        {name: 'Previous', code: 'KC_MPRV', title: 'Media Previous', shortName: 'Prev'},
    ...
    buildLayerMenu(),
    {
      ...
      keycodes: [
        ...
        {name: 'Favorites', code: 'KC_WWW_FAVORITES', shortName: 'Fav', title: 'Favorites'},
        ...
        {name: 'Mouse Btn 1', code: 'KC_MS_BTN1'},
        {name: 'Mouse Btn 2', code: 'KC_MS_BTN2'},
        {name: 'Mouse Btn 3', code: 'KC_MS_BTN3'},
        {name: 'Mouse Btn 4', code: 'KC_MS_BTN4'},
        {name: 'Mouse Btn 5', code: 'KC_MS_BTN5'},
        {name: 'Mouse Btn 6', code: 'KC_MS_BTN6'},
        {name: 'Mouse Btn 7', code: 'KC_MS_BTN7'},
        {name: 'Mouse Btn 8', code: 'KC_MS_BTN8'},
        ...
        {name: 'Mouse Acc 0', code: 'KC_MS_ACCEL0'},
        {name: 'Mouse Acc 1', code: 'KC_MS_ACCEL1'},
        {name: 'Mouse Acc 2', code: 'KC_MS_ACCEL2'},
